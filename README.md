...
2. Install [Steamodded](https://github.com/Steamopollys/steamodded), if you haven't already. (Due to breaking changes, [**1304a aka old-calc**](https://github.com/Steamodded/smods/releases/tag/old-calc) is the only supported version.)
3. Download the code as a ZIP file, from the latest release in Releases. (The "Code" button gets you the most recent commit, which **is definitely buggy** right now, as we are currently updating to Better Calc.)
