let jokers = [
  {
    name: "Hedonist Joker",
    text: [
      "Played {C:minty_3s}3s{} give {C:mult}+3{} Mult when scored"
          ],
    image_url: "img/hedonist mockup.png",
    rarity: "Common"
  },
  {
  name: "Frozen Yogurt",
  text: [
      "{C:chips}+50{} Chips, {C:chips}-5{} Chips for every hand played",
      "{C:inactive}(But it's so much cheaper!)"
        ],
  image_url: "img/froyo mockup.png",
  rarity: "Common"
  },
  {
  name: "Fossilized Claw",
  text: [
      "{C:green}1 in 3{} chance for played {C:minty_3s}3s{} to give {X:mult,C:white}X3{} Mult when scored",
        ],
  image_url: "img/claw mockup.png",
  rarity: "Uncommon"
  },
  {
  name: "Prosopagnosia",
  text: [
      "{X:mult,C:white} X5{} Mult if hand contains {C:attention}face{} cards, but {C:attention}no{} cards are considered face cards.",
        ],
  image_url: "img/prosopagnosia mockup.png",
  rarity: "Uncommon"
  },
  {
  name: "Three Cats!",
  text: [
      "{C:minty_3s}3s{} give one of {C:chips}+33{} chips, {C:mult}+13{} Mult, or {X:mult,C:white}X3{} Mult when scored."
        ],
  image_url: "img/three cats mockup.png",
  rarity: "Fusion"
  },
]
...
let consumables = [
  {
    name: "The Cat",
    text: [
      "Converts up to {C:attention}3{} selected cards to {C:minty_3s}3s{}"
    ],
    image_url: "img/the cat mockup.png",
    rarity: "Tarot"
  },
  {
    name: "6 Years",
    text: [
      "Add a {C:cement}Cement Seal{} to {C:attention}1{} selected card in your hand"
    ],
    image_url: "img/spectral placeholder.png",
    rarity: "Spectral"
  },
]
...
let card_modifications = [
  {
    ...
    text: [
      ...
      "({C:chips}+50 Chips{}, scores even if not part of played hand, resistant to debuffs)"
    ],
    image_url: "img/cementseal.png",
    rarity: "Seal"
  },
]
...
let blinds = [
  {
    ...
    text: [
      ...
      "{C:inactive}(Appears from Ante 3)"
    ],
    image_url: "img/the_nip.png",
    rarity: "Boss Blind"
  },
  // {
  //   name: "Violet Vessel",
